...
export interface CharacterProfile {
  ...
  /**
   * SAME_SPACE_CHAT: 普通私聊内的轻量线下状态。它不复用见面模式存档，
   * 不参与 Worker / D1，也不随角色卡分享（见 utils/characterCard.ts）。
   */
  sameSpaceChat?: import('./features/sameSpaceChat/model').SameSpaceChatState;
